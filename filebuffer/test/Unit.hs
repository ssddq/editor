...
filebufferTests = describe "filebuffer" $ do
  ...
  specify "1" $
    (move Up 1 . delete 1 . insert "?" . move Down 1 . move Down 1 . delete 1 . insert "?" . move Down 1 $ filebuffer).cursor
      `shouldBe`
    Position 15 0
  specify "2" $
    (move Down 1 . delete 1 . move Up 1 . move Up 1 .  move Up 1 . delete 1 . insert "?" . move Down 1 . move Down 1 . delete 1 . insert "?" . move Down 1 $ filebuffer).cursor
      `shouldBe`
    Position 15 0
